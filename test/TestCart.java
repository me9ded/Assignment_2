...
class TestCart {
	...
	public void test1CreateProducts() {
		...
		AmazonProduct ap;
		String[] data;
		System.out.println("[Test3.1: Creating products]...");
		data = new String[] {};
	...
	public void test2CreateUsers() {
		// Creating users
		System.out.println("[Test3.2: Creating users]...");
	...
	public void test3CreateWishList() {
		System.out.println("[Test3.3: Creating wishlist]...");
		...
		int numberOfItems = 5;
		item = new AmazonCartItem(product, numberOfItems);
		customer.addItemInCart(item);
		product = productList.get(1);
		numberOfItems = 1;
		item = new AmazonCartItem(product, numberOfItems);
		customer.addItemInCart(item);
		System.out.println("  * Number of items in the cart: " + customer.getCartSize());
